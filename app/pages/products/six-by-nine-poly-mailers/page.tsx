      ...
      <main className="container mx-auto px-4 py-8">
        ...
        <nav className="mb-8">
          <ol className="flex items-center space-x-2 text-sm text-gray-500">
            <li>Home</li>
            <li>•</li>
            <li className="font-medium text-gray-900">Polymailers</li>
          </ol>
        </nav>
  ...
  <div className="flex-1 text-center md:text-left mb-4 md:mb-0">
    ...
    <div className="p-6 font-sans overflow-hidden">
      ...
      <div className="text-gray-700">
        {activeTab === 'details' && (
          <section>
            <h2 className="text-2xl font-semibold mb-4">Custom Polymailers</h2>
            <p className="mb-4">
        ...
        {activeTab === 'print' && (
          <section>
            ...
            <p className="mb-4">
            You can choose direct printing to get high-quality mylar bags. This printing method ensures that ink pops on boxes and you can win the hearts of your customers. You can customize mylar bags with embossing/debossing, silver/gold foiling, or any customization style you like!                     </p>
          </section>
        )}
      </div>
    </div>
