...
const productImages = [
  "/Images/soap-nobg/soap-nobg1.png",
  "/Images/soap-nobg/soap-nobg2.png",
  "/Images/soap-nobg/soap-nobg3.png",
  "/Images/soap-nobg/soap-nobg4.png",
];
      ...
      <main className="container mx-auto px-4 py-8">
        ...
        <nav className="mb-8">
          <ol className="flex items-center space-x-2 text-sm text-gray-500">
            <li>Home</li>
            <li>•</li>
            <li className="font-medium text-gray-900"> Soap Boxes</li>
          </ol>
        </nav>
  ...
  <div className="grid grid-cols-4 xs:grid-cols-2 sm:grid-cols-4 gap-2 mt-4">
    {productImages.map((image, index) => (
      ...
      >
        ...
        <div className="text-center">
          ...
          Soap Boxes: Custom-fitted boxes to protect and showcase soap bars beautifully
          </h2>
        </div>
      </main>
    </div>
    ...
    <div className="p-6 font-sans overflow-hidden">
      ...
      <div className="text-gray-700">
        {activeTab === 'details' && (
          <section>
            <h2 className="text-2xl font-semibold mb-4">Custom Soap Boxes</h2>
            <p className="mb-4">
            Get branded soap boxes designed for brands who love nothing but packaging perfection. You can choose the right material and pick any customization style you like. Ping us to get a free quote for your packaging needs.                      </p>
          </section>
        )}
        ...
        {activeTab === 'specification' && (
          <section>
            ...
            <p className="mb-4">
            You can get custom soap boxes in any shape or size. The best option is reverse-tuck packaging style as it looks stylish and provides a great unboxing experience. Got something else in mind? Just let us know and we’ll create the design 100% free for you!                      </p>
          </section>
        )}
        ...
        {activeTab === 'material' && (
          <section>
            ...
            <p className="mb-4">
            You can use kraft, cardstock, or cardboard for custom soap boxes. All the materials are sturdy and good for printing. Or you can choose paperboard to get luxury rigid boxes for your amazing soap brand!                     </p>
          </section>
        )}
        ...
        {activeTab === 'print' && (
          <section>
            ...
            <p className="mb-4">
            You can rely on offset printing to get high-quality soap boxes. This printing method ensures that ink pops on boxes and you can win the hearts of your customers. You can customize soap boxes with embossing/debossing, silver/gold foiling, or any customization style you like!
            </p>
          </section>
        )}
      </div>
