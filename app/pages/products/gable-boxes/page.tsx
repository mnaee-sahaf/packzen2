  ...
  <div className="grid grid-cols-4 xs:grid-cols-2 sm:grid-cols-4 gap-2 mt-4">
    ...
    <div className="p-6 font-sans overflow-hidden">
      ...
      <div className="text-gray-700">
        {activeTab === 'details' && (
          <section>
            <h2 className="text-2xl font-semibold mb-4">Custom Gable Boxes</h2>
            <p className="mb-4">
            Get branded gable boxes designed for brands who love nothing but packaging perfection. You can choose the right material and pick any customization style you like. Ping us to get a free quote for your packaging needs.
                                    </p>
          </section>
        )}
        ...
        {activeTab === 'specification' && (
          <section>
            ...
            <p className="mb-4">
            You can get custom gable boxes in any shape or size. The best option is die-cut PVC window style as it looks stylish and provides a great unboxing experience. Got something else in mind? Just let us know and we’ll create the design 100% free for you!                      </p>
          </section>
        )}
        ...
        {activeTab === 'material' && (
          <section>
            ...
            <p className="mb-4">
            You can use kraft, cardstock, or cardboard for personalized Gable boxes. All the materials are sturdy and good for printing. Or you can choose paperboard to get luxury rigid boxes for your amazing candle brand!     
                   </p>
          </section>
        )}
        ...
        {activeTab === 'print' && (
          <section>
            ...
            <p className="mb-4">
            You can rely on offset printing to get high-quality gable boxes. This printing method ensures that ink pops on boxes and you can win the hearts of your customers. You can customize gable bar boxes with embossing/debossing, silver/gold foiling, or any customization style you like!                       </p>
          </section>
        )}
      </div>
    </div>
