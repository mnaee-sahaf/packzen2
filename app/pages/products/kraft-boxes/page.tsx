...
const productImages = [
  "/Images/kraft-nobg/kraft-nobg1.png",
  "/Images/kraft-nobg/kraft-nobg2.png",
  "/Images/kraft-nobg/kraft-nobg3.png",
  "/Images/kraft-nobg/kraft-nobg4.png",
];
      ...
      <main className="container mx-auto px-4 py-8">
        ...
        <nav className="mb-8">
          <ol className="flex items-center space-x-2 text-sm text-gray-500">
            <li>Home</li>
            <li>•</li>
            <li className="font-medium text-gray-900">Kraft Boxes</li>
          </ol>
        </nav>
  ...
  <div className="grid grid-cols-4 xs:grid-cols-2 sm:grid-cols-4 gap-2 mt-4">
    {productImages.map((image, index) => (
      ...
      >
        ...
        <div className="text-center">
          ...
          Kraft Boxes: Eco-friendly, durable packaging ideal for natural or artisanal products
          </h2>
        </div>
      </main>
    </div>
    ...
    <div className="p-6 font-sans overflow-hidden">
      ...
      <div className="text-gray-700">
        {activeTab === 'details' && (
          <section>
            <h2 className="text-2xl font-semibold mb-4">Custom Kraft Boxes</h2>
            <p className="mb-4">
            Get branded kraft boxes designed for brands who love nothing but packaging perfection. Choose any box style and pick any customization style that suits your needs. Ping us to get a free quote for your packaging needs.                       </p>
          </section>
        )}
        ...
        {activeTab === 'specification' && (
          <section>
            ...
            <p className="mb-4">
            You can get custom kraft boxes in any shape or size. The best option is tuck packaging style as it looks stylish and provides a great unboxing experience. Got something else in mind? Just let us know and we’ll create the design 100% free for you!                       </p>
          </section>
        )}
        ...
        {activeTab === 'material' && (
          <section>
            ...
            <p className="mb-4">
            You can use virgin kraft or colored kraft material for your boxes. Both types of these materials are sustainable and good for printing. Ping us now to discuss your packaging needs and get the right kraft material for your boxes.                         </p>
          </section>
        )}
        ...
        {activeTab === 'print' && (
          <section>
            ...
            <p className="mb-4">
            You can rely on offset printing to get high-quality kraft boxes. This printing method ensures that ink pops on boxes and you can win the hearts of your customers. You can customize kraft boxes with embossing/debossing, silver/gold foiling, or any customization style you like!                       </p>
          </section>
        )}
      </div>
    </div>
