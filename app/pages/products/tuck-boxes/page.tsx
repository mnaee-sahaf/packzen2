      ...
      <main className="container mx-auto px-4 py-8">
        ...
        <nav className="mb-8">
          <ol className="flex items-center space-x-2 text-sm text-gray-500">
            <li>Home</li>
            <li>•</li>
            <li className="font-medium text-gray-900">Custom Tuck Boxes</li>
          </ol>
        </nav>
    ...
    {productImages.map((image, index) => (
      ...
      >
        ...
        <div className="text-center">
          ...
          Tuck Boxes: Lightweight and economical boxes for retail items and small products
          </h2>
        </div>
      </main>
    </div>
