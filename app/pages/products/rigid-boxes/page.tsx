      ...
      <main className="container mx-auto px-4 py-8">
        ...
        <nav className="mb-8">
          <ol className="flex items-center space-x-2 text-sm text-gray-500">
            <li>Home</li>
            <li>•</li>
            <li className="font-medium text-gray-900">Rigid Boxes</li>
          </ol>
        </nav>
    ...
    {productImages.map((image, index) => (
      ...
      >
            ...
            <div className="space-y-6">
              <div>
                ...
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-gray-600">72 Reviews</span>
                </div>
              </div>
        ...
        <div className="text-center">
          ...
          Rigid Boxes: Premium, sturdy packaging for high-end products and luxury gifting
          </h2>
        </div>
      </main>
    </div>
