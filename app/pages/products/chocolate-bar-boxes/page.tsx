...
const productImages = [
  "/Images/Chocolate/choco1.png",
  "/Images/Chocolate/choco2.png",
  "/Images/Chocolate/choco3.png",
  "/Images/Chocolate/choco4.png",
];
      ...
      <main className="container mx-auto px-4 py-8">
        ...
        <nav className="mb-8">
          <ol className="flex items-center space-x-2 text-sm text-gray-500">
            <li>Home</li>
            <li>•</li>
            <li className="font-medium text-gray-900">Chocolate Bar Boxes</li>
          </ol>
        </nav>
